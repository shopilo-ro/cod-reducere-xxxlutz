#!/usr/bin/env python3
"""
Fetch coduri de reducere XXXLutz de pe shopilo.ro
Sursa: https://shopilo.ro/magazin/xxxlutz.ro
"""
...
SHOPILO_URL = "https://shopilo.ro/magazin/xxxlutz.ro"
STORE_NAME = "XXXLutz"


def fetch_coupons(url=SHOPILO_URL):
    """Returneaza lista de cupoane active pentru XXXLutz de pe shopilo.ro"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-ro/cod-reducere-xxxlutz)"
    }
    try:
